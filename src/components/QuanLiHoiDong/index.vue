                                    ...
                                    <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
                                                    <button type="button" class="btn btn-primary" @:click="chiaNhom()">Chia Vào Nhóm</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal fade" id="xoaModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
                                                    <button type="button" class="btn btn-primary" @:click="xoaHoiDong()">Xóa Hội Đồng</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="modal fade" id="editModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                                        <div class="modal-dialog">
                                            <div class="modal-content">
                                                ...
                                                <div class="modal-footer">
                                                    <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Đóng</button>
                                                    <button type="button" class="btn btn-primary" @:click="capNhat()">Cập Nhật Hội Đồng</button>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <tbody>
                                                <template v-for="(value, key) in list">
                                                    <tr>
                                                        ...
                                                        <td>
                                                            <button style="margin-right: 10px;" class="btn btn-info" v-on:click="id_hoi_dong = value.id; xoa_hoi_dong = value" data-bs-toggle="modal" data-bs-target="#staticSua">Sửa</button>
...
export default {
    ...
    methods: {
        ...
        {
            baseRequest
                .get("hoi-dong/data-danh-sach-nhom")
                .then((res) => {
        ...
        them(){
            ...
            baseRequest
                .post("hoi-dong/create", this.hoi_dong_add)
                .then((res) => {
        ...
        chiaNhom() {
            ...
            baseRequest
                .post("hoi-dong/chia-nhom", payload)
                .then((res) => {
                    console.log(res);
                    functionBasic.displaySuccess(res);
                    this.load();
        ...
        xoaNhom() {
            baseRequest
                .post("hoi-dong/delete-nhom", this.xoa_nhom)
                .then((res) => {
                    functionBasic.displaySuccess(res);
                });
        },
        capNhat() {
            baseRequest
                .post("hoi-dong/update-hoi-dong", this.edit_hoi_dong)
                .then((res) => {
                    functionBasic.displaySuccess(res);
                    this.load();
                });
        ...
        xoaHoiDong() {
            baseRequest
                .post("hoi-dong/xoa-hoi-dong", this.xoa_hoi_dong)
                .then((res) => {
                    functionBasic.displaySuccess(res);
                    this.load();
                });
        ...
        doiNhom() {
            ...
            baseRequest
                .post("hoi-dong/update-nhom", payload)
                .then((res) => {
                    functionBasic.displaySuccess(res);
                    this.loadDanhSach();
                });
